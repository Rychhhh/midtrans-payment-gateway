                  ...
                  <div class="row">
                    ...
                    <form class="form-row" action="{{ url('checkout') }}" method="POST">
                        ...
                        <div class="form-group col-md-12">
                            <label class="form-label col-lg-12">Pesan Berapa?</label>
                            <input type="number" class="form-control col-lg-12" name="qty" autocomplete>
                        </div>
                        <div class="form-group col-md-12">
                            <label lass="form-label col-lg-12">Nama</label>
                            <input type="text" class="form-control col-lg-12" name="name" >
                        </div>
                        <div class="form-group col-md-12">
                            <label class="form-label col-lg-12">Nomor Telepon</label>
                            <input type="number" class="form-control col-lg-12" name="phone" >
                        </div>
                        <div class="form-group col-md-12">
                            <label  class="form-label col-lg-12">Alamat</label>
                            <input type="text" class="form-control col-lg-12" name="alamat">
                        </div>

                      <h6 class="text-success mt-3">Free shipping</h6>
                      <div class="d-flex flex-column mt-4">
                        <button class="btn btn-primary btn-sm" type="button">Details</button>
                        <button type="submit" class="btn btn-outline-primary btn-sm mt-2" type="button">
                          Checkout
                        </button>
                      </div>
                    </form>
